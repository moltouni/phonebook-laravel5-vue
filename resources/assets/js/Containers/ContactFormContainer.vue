<template>
    <div class="container contact-form">
        ...
        <div class='row'>
            <div class='col'>
                <button v-if="contact.id" @click='deleteContact(contact.id)' class="contact-form-delete btn btn-outline-danger">Delete contact</button>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class='col contact-form-left'>

                <div class='row'>
                    <div class='col'>
                        <div class="form-group">
                            <label for="firstName"><h4>First name</h4></label>
                            <input v-model="contact.first_name" type="text" class="form-control" id="firstName"  placeholder="Enter first name">
                        </div>
                    </div>
                </div>
                ...
                <div class='row'>
                    <div class='col'>
                        <div class="form-group">
                            ...
                            <input v-model="contact.last_name" type="text" class="form-control" id="lastName"  placeholder="Enter last name">
                        </div>                                
                    </div>
                </div>
                ...
                <div class='form-group'>
                    <label for="favorite"><h4>Favorite</h4></label>
                    <toggle-button v-model="contact.favorite" :width="100" :height="32" :value="false" :sync="true" :labels="true" class="favorite" id="favorite"/>                    
                </div>

                <!-- Phones -->
                <div class="contact-form-phones">

                    <h4>Phones <button @click="addPhoneField" class='btn btn-outline-secondary'>Add</button></h4>
                    ...
                    <div v-for="(phone, index) in phones" :key="phone.id">
                        ...
                        <div class="row contact-form-phones-item">
                            ...
                            <div class="col">
                                <button @click="removePhoneField(index)" class='btn btn-outline-secondary'>Remove phone</button>
                            </div>
                        </div>
    ...
    export default {
        ...
        methods: {
            ...
            redirectToContact: function () {
                this.$router.push({ name: 'contact-single', params: {
